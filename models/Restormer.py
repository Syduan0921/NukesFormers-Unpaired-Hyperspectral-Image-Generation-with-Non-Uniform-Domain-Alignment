...
class Restormer(nn.Module):
    ...
    def forward(self, inp_img, layers=[], encode_only=False):
        ...
        if len(layers) > 0:
            if encode_only:
                ...
                return [out_dec_level1[:, :, :h_inp, :w_inp]] # return intermediate features alone; stop in the last layers
            else:
                return out_dec_level1[:, :, :h_inp, :w_inp], [out_dec_level1[:, :, :h_inp, :w_inp]]
        else:
