...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataroot', default="/home/data/dsy/data/DCD_dataset/CAVE/", help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        parser.add_argument('--checkpoints_dir', type=str, default='/home/data/dsy/code/NukesFormers/Checkpoints/', help='models are saved here')
        # model parameters
        parser.add_argument('--model', type=str, default='srcut', help='chooses which model to use.')
        parser.add_argument('--input_nc', type=int, default=3, help='# of input image channels: 3 for RGB and 1 for grayscale')
        parser.add_argument('--output_nc', type=int, default=31, help='# of output image channels: 3 for RGB and 1 for grayscale')
        parser.add_argument('--ngf', type=int, default=64, help='# of gen filters in the last conv layer')#64
        ...
        parser.add_argument('--netG', type=str, default='NukesFormers', help='specify generator architecture')
        ...
        parser.add_argument('--idex', default=16, type=int,
