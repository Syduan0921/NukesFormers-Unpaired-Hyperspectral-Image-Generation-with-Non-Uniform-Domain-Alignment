...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--choose_patch', type=int, default=256, help='choose sort patches or not')
        ...
        parser.add_argument('--outf', type=str, default="/home/data/dsy/code/Export-Unpaired_SR/checkpoints/10_14/CAVE_rest++/",
                            help='output path')
